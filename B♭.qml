...
MuseScore {
   ...
   menuPath: "Plugins.Notes." + qsTr("B♭ Solfa") // this does not work, why?
   ...
   function nameChord (notes, text) {
      for (var i = 0; i < notes.length; i++) {
         ...
         if (typeof notes[i].tpc === "undefined") // like for grace notes ?!?
            return
         switch (notes[i].tpc) {
            case -1: text.text = qsTranslate("Inspectortmbitus", "s♭♭") + text.text; break;
            case  0: text.text = qsTranslate("Inspectortmbitus", "r♭♭") + text.text; break;
            case  1: text.text = qsTranslate("Inspectortmbitus", "l♭♭") + text.text; break;
            case  2: text.text = qsTranslate("Inspectortmbitus", "m♭♭") + text.text; break;
            case  3: text.text = qsTranslate("Inspectortmbitus", "t♭♭") + text.text; break;
            case  4: text.text = qsTranslate("Inspectortmbitus", "f♭♭") + text.text; break;
            case  5: text.text = qsTranslate("Inspectortmbitus", "d♭♭") + text.text; break;
            ...
            case 14: text.text = qsTranslate("Inspectortmbitus", "r")   + text.text; break;
            case 15: text.text = qsTranslate("Inspectortmbitus", "l")   + text.text; break;
            case 16: text.text = qsTranslate("Inspectortmbitus", "m")   + text.text; break;
            case 17: text.text = qsTranslate("Inspectortmbitus", "t")   + text.text; break;
            case 18: text.text = qsTranslate("Inspectortmbitus", "fe")   + text.text; break;
            ...
            case 30: text.text = qsTranslate("Inspectortmbitus", "m♯♯") + text.text; break;
            case 31: text.text = qsTranslate("Inspectortmbitus", "t♯♯") + text.text; break;
            case 32: text.text = qsTranslate("Inspectortmbitus", "f♯♯") + text.text; break;
            case 33: text.text = qsTranslate("Inspectortmbitus", "d♯♯") + text.text; break;
