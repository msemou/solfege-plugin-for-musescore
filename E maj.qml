...
MuseScore {
   ...
   menuPath: "Plugins.Notes." + qsTr("E major") // this does not work, why?
   ...
   function nameChord (notes, text) {
      for (var i = 0; i < notes.length; i++) {
         ...
         if (typeof notes[i].tpc === "undefined") // like for grace notes ?!?
            return
         switch (notes[i].tpc) {
            case -1: text.text = qsTranslate("Inspectorfmbitus", "r♭♭") + text.text; break;
            case  0: text.text = qsTranslate("Inspectorfmbitus", "l♭♭") + text.text; break;
            case  1: text.text = qsTranslate("Inspectorfmbitus", "m♭♭") + text.text; break;
            case  2: text.text = qsTranslate("Inspectorfmbitus", "t♭♭") + text.text; break;
            case  3: text.text = qsTranslate("Inspectorfmbitus", "f♭♭") + text.text; break;
            case  4: text.text = qsTranslate("Inspectorfmbitus", "d♭♭") + text.text; break;
            case  5: text.text = qsTranslate("Inspectorfmbitus", "s♭♭") + text.text; break;
            case  6: text.text = qsTranslate("Inspectorfmbitus", "r♭")  + text.text; break;
            case  7: text.text = qsTranslate("Inspectorfmbitus", "le")  + text.text; break;

            case  8: text.text = qsTranslate("Inspectorfmbitus", "ma")  + text.text; break;
            case  9: text.text = qsTranslate("Inspectorfmbitus", "ta")  + text.text; break;
            case 10: text.text = qsTranslate("Inspectorfmbitus", "m")  + text.text; break;
            case 11: text.text = qsTranslate("Inspectorfmbitus", "t")  + text.text; break;
            case 12: text.text = qsTranslate("Inspectorfmbitus", "se")  + text.text; break;
            case 13: text.text = qsTranslate("Inspectorfmbitus", "r")   + text.text; break;
            case 14: text.text = qsTranslate("Inspectorfmbitus", "l")   + text.text; break;
            case 15: text.text = qsTranslate("Inspectorfmbitus", "m")   + text.text; break;
            case 16: text.text = qsTranslate("Inspectorfmbitus", "t")   + text.text; break;
            case 17: text.text = qsTranslate("Inspectorfmbitus", "f")   + text.text; break;
            case 18: text.text = qsTranslate("Inspectorfmbitus", "d")   + text.text; break;
            case 19: text.text = qsTranslate("Inspectorfmbitus", "s")   + text.text; break;

            case 20: text.text = qsTranslate("Inspectorfmbitus", "ri")  + text.text; break;
            case 21: text.text = qsTranslate("Inspectorfmbitus", "li")  + text.text; break;
            case 22: text.text = qsTranslate("Inspectorfmbitus", "f")  + text.text; break;
            case 23: text.text = qsTranslate("Inspectorfmbitus", "d")  + text.text; break;
            case 24: text.text = qsTranslate("Inspectorfmbitus", "fe")  + text.text; break;
            case 25: text.text = qsTranslate("Inspectorfmbitus", "de")  + text.text; break;
            case 26: text.text = qsTranslate("Inspectorfmbitus", "se")  + text.text; break;
            case 27: text.text = qsTranslate("Inspectorfmbitus", "r♯♯") + text.text; break;
            case 28: text.text = qsTranslate("Inspectorfmbitus", "l♯♯") + text.text; break;
            case 29: text.text = qsTranslate("Inspectorfmbitus", "m♯♯") + text.text; break;
            case 30: text.text = qsTranslate("Inspectorfmbitus", "t♯♯") + text.text; break;
            case 31: text.text = qsTranslate("Inspectorfmbitus", "f♯♯") + text.text; break;
            case 32: text.text = qsTranslate("Inspectorfmbitus", "d♯♯") + text.text; break;
            case 33: text.text = qsTranslate("Inspectorfmbitus", "s♯♯") + text.text; break;
