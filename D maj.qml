...
MuseScore {
   ...
   menuPath: "Plugins.Notes." + qsTr("D major") // this does not work, why?
      ...
      for (var i = 0; i < notes.length; i++) {
         ...
         switch (notes[i].tpc) {
           case -1: text.text = qsTranslate("Inspectorsmbitus", "m♭♭") + text.text; break;
            ...
            case 16: text.text = qsTranslate("Inspectorsmbitus", "d")   + text.text; break;
            case 17: text.text = qsTranslate("Inspectorsmbitus", "s")   + text.text; break;
            case 18: text.text = qsTranslate("Inspectorsmbitus", "r")   + text.text; break;
            case 19: text.text = qsTranslate("Inspectorsmbitus", "l")   + text.text; break;

            case 20: text.text = qsTranslate("Inspectorsmbitus", "m")  + text.text; break;
            case 21: text.text = qsTranslate("Inspectorsmbitus", "t")  + text.text; break;
            case 22: text.text = qsTranslate("Inspectorsmbitus", "fe")  + text.text; break;
            case 23: text.text = qsTranslate("Inspectorsmbitus", "de")  + text.text; break;
