...
MuseScore {
   ...
   menuPath: "Plugins.Notes." + qsTr("C") // this does not work, why?
   ...
   function nameChord (notes, text) {
      for (var i = 0; i < notes.length; i++) {
         ...
         if (typeof notes[i].tpc === "undefined") // like for grace notes ?!?
            return
         switch (notes[i].tpc) {
           case -1: text.text = qsTranslate("Inspectorlmbitus", "f♭♭") + text.text; break;
            case  0: text.text = qsTranslate("Inspectorlmbitus", "d♭♭") + text.text; break;
            case  1: text.text = qsTranslate("Inspectorlmbitus", "s♭♭") + text.text; break;
            case  2: text.text = qsTranslate("Inspectorlmbitus", "r♭♭") + text.text; break;
            case  3: text.text = qsTranslate("Inspectorlmbitus", "l♭♭") + text.text; break;
            case  4: text.text = qsTranslate("Inspectorlmbitus", "m♭♭") + text.text; break;
            case  5: text.text = qsTranslate("Inspectorlmbitus", "t♭♭") + text.text; break;
            case  6: text.text = qsTranslate("Inspectorlmbitus", "f♭")  + text.text; break;
            case  7: text.text = qsTranslate("Inspectorlmbitus", "d♭")  + text.text; break;

            case  8: text.text = qsTranslate("Inspectorlmbitus", "se")  + text.text; break;
            case  9: text.text = qsTranslate("Inspectorlmbitus", "ro")  + text.text; break;
            case 10: text.text = qsTranslate("Inspectorlmbitus", "le")  + text.text; break;
            case 11: text.text = qsTranslate("Inspectorlmbitus", "ma")  + text.text; break;
            case 12: text.text = qsTranslate("Inspectorlmbitus", "ta")  + text.text; break;
            case 13: text.text = qsTranslate("Inspectorlmbitus", "f")   + text.text; break;
            case 14: text.text = qsTranslate("Inspectorlmbitus", "d")   + text.text; break;
            case 15: text.text = qsTranslate("Inspectorlmbitus", "s")   + text.text; break;
            case 16: text.text = qsTranslate("Inspectorlmbitus", "r")   + text.text; break;
            case 17: text.text = qsTranslate("Inspectorlmbitus", "l")   + text.text; break;
            case 18: text.text = qsTranslate("Inspectorlmbitus", "m")   + text.text; break;
            case 19: text.text = qsTranslate("Inspectorlmbitus", "t")   + text.text; break;

            case 20: text.text = qsTranslate("Inspectorlmbitus", "fe")  + text.text; break;
            case 21: text.text = qsTranslate("Inspectorlmbitus", "de")  + text.text; break;
            case 22: text.text = qsTranslate("Inspectorlmbitus", "se")  + text.text; break;
            case 23: text.text = qsTranslate("Inspectorlmbitus", "ri")  + text.text; break;
            case 24: text.text = qsTranslate("Inspectorlmbitus", "li")  + text.text; break;
            case 25: text.text = qsTranslate("Inspectorlmbitus", "m♯")  + text.text; break;
            case 26: text.text = qsTranslate("Inspectorlmbitus", "t♯")  + text.text; break;
            case 27: text.text = qsTranslate("Inspectorlmbitus", "f♯♯") + text.text; break;
            case 28: text.text = qsTranslate("Inspectorlmbitus", "d♯♯") + text.text; break;
            case 29: text.text = qsTranslate("Inspectorlmbitus", "s♯♯") + text.text; break;
            case 30: text.text = qsTranslate("Inspectorlmbitus", "r♯♯") + text.text; break;
            case 31: text.text = qsTranslate("Inspectorlmbitus", "l♯♯") + text.text; break;
            case 32: text.text = qsTranslate("Inspectorlmbitus", "m♯♯") + text.text; break;
            case 33: text.text = qsTranslate("Inspectorlmbitus", "t♯♯") + text.text; break;
